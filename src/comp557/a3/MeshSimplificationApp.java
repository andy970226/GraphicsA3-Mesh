...
public class MeshSimplificationApp implements SceneGraphNode, Interactor {
    ...
    public MeshSimplificationApp() {    
        ...
        EasyViewer ev = new EasyViewer("Comp 557 Mesh Simplification -Andi Dai 260844907", this, new Dimension(400, 400), new Dimension(600, 650) );
    ...
    private void loadSoupBuildAndSubdivide( String filename ) {
        ...
        //	currentHE = heds.faces.iterator().next().he;
        	currentHE=heds.setcollapseedge();
        else if ( heds.faces.size() > 0 ) {
        	currentHE = heds.faces.iterator().next().he;
        }
    }
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        if (  drawEdgeErrors.getValue() ) {  
        	heds.setregularization(regularizationWeight.getFloatValue());
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_SPACE) {
                	...
                	if ( e.isShiftDown() ) {
                		...
                		} while ( heds.IsCollapsible(currentHE) );
